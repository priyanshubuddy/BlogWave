  ...
  <div className="bg-white shadow-lg rounded-lg p-0 lg:p-4 pb-12 mb-8">
    ...
    <div className="relative overflow-hidden shadow-md pb-80 mb-6">
      <img
        src={post.featuredImage.url}
        alt=""
        className="object-top absolute h-80 w-full object-cover  shadow-lg rounded-t-lg lg:rounded-lg p-2"
      />
    </div>

    <h1 className="transition duration-700 text-center mx-1 mb-8 cursor-pointer hover:text-pink-600 text-3xl font-semibold">
